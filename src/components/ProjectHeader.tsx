...
export const ProjectHeader = () => {
  ...
  return <div className="border-b border-gray-200 my-0 mx-0 py-0 px-[5px] rounded-none bg-[#081d39]">
      <div className="flex justify-between items-center w-full my-0 py-0 px-0 mx-0 bg-[#09274b]">
