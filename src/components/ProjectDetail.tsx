      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditedProject({ ...editedProject, areaNegocio: e.target.value })}
                  />
                </div>
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value: 'Inovação' | 'Melhoria') => 
                      setEditedProject({ ...editedProject, inovacaoMelhoria: value })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditedProject({ ...editedProject, timeTI: e.target.value })}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditedProject({ ...editedProject, sponsor: e.target.value })}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditedProject({ ...editedProject, productOwner: e.target.value })}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditedProject({ ...editedProject, gerenteProjetos: e.target.value })}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditedProject({ ...editedProject, liderProjetosTI: e.target.value })}
                  />
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                ...
                <Button
                  size="sm"
                  onClick={() => addToList('etapasExecutadas', { atividade: '', dataConclusao: '' })}
                  className="flex items-center gap-1"
                >
                  <Plus className="h-3 w-3" />
                  Adicionar
                      ...
                      <tr key={index}>
                        <td className="border border-gray-200 p-2">
                          <Input
                            ...
                            onChange={(e) => updateListItem('etapasExecutadas', index, { ...etapa, atividade: e.target.value })}
                        ...
                        <td className="border border-gray-200 p-2">
                          <Input
                            ...
                            onChange={(e) => updateListItem('etapasExecutadas', index, { ...etapa, dataConclusao: e.target.value })}
                          />
                        </td>
                        <td className="border border-gray-200 p-2">
                          <Button
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                ...
                <Button
                  size="sm"
                  onClick={() => addToList('proximasEtapas', { atividade: '', responsavel: '', previsao: '' })}
                  className="flex items-center gap-1"
                >
                  <Plus className="h-3 w-3" />
                  Adicionar
                    ...
                    {editedProject.proximasEtapas.map((etapa, index) => (
                      <tr key={index}>
                        <td className="border border-gray-200 p-2">
                          <Input
                            value={etapa.atividade}
                            onChange={(e) => updateListItem('proximasEtapas', index, { ...etapa, atividade: e.target.value })}
                        ...
                        <td className="border border-gray-200 p-2">
                          <Input
                            ...
                            onChange={(e) => updateListItem('proximasEtapas', index, { ...etapa, responsavel: e.target.value })}
                        ...
                        <td className="border border-gray-200 p-2">
                          <Input
                            ...
                            onChange={(e) => updateListItem('proximasEtapas', index, { ...etapa, previsao: e.target.value })}
                          />
                        </td>
                        <td className="border border-gray-200 p-2">
                      ...
                      return (
                        <tr key={index}>
                          <td className="border border-gray-200 p-2">
                            <Input
                              value={item.etapa}
                              onChange={(e) => updateListItem('cronograma', index, { ...item, etapa: e.target.value })}
                          ...
                          <td className="border border-gray-200 p-2">
                            <Input
                              type="date"
                              value={item.inicio}
                              onChange={(e) => updateListItem('cronograma', index, { ...item, inicio: e.target.value })}
                            />
                          </td>
                          <td className="border border-gray-200 p-2">
                            <Input
                              type="date"
                              value={item.fim}
                              onChange={(e) => updateListItem('cronograma', index, { ...item, fim: e.target.value })}
                              min={item.inicio}
                            />
                          </td>
                          <td className="border border-gray-200 p-2">
          ...
          <Card>
            ...
            <CardContent>
              <div>
                <Label htmlFor="estrategicoTatico">Estratégico/Tático</Label>
                <Select
                  value={editedProject.estrategicoTatico}
                  onValueChange={(value: 'Estratégico' | 'Tático') => 
                    setEditedProject({ ...editedProject, estrategicoTatico: value })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
